...
<template>
  <ProjectsInfo>
    ...
    <template #description>
      ...
      <p>
        Visit the site
        <a href="https://oscarchilds.github.io/desktop-portfolio/" target="_blank">here</a> or on
        <a href="https://github.com/oscarchilds/desktop-portfolio" target="_blank">GitHub</a>
      </p>
    </template>
  </ProjectsInfo>
</template>
